package com.eatsfine.domain.booking.repository;
...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("select max(b.bookingDate) from Booking b " +
            "where b.store.id = :storeId " +
            "and b.status IN (com.eatsfine.domain.booking.enums.BookingStatus.CONFIRMED, com.eatsfine.domain.booking.enums.BookingStatus.PENDING) " +
    ...
    @Query("select count(b) from Booking b " +
            "where b.store = :store " +
            "and b.status in (com.eatsfine.domain.booking.enums.BookingStatus.CONFIRMED, " +
            "com.eatsfine.domain.booking.enums.BookingStatus.PENDING, " +
            "com.eatsfine.domain.booking.enums.BookingStatus.COMPLETED)")
