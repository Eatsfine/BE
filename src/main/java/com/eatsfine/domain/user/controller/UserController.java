package com.eatsfine.domain.user.controller;
...
import com.eatsfine.domain.user.service.user.UserService;
import com.eatsfine.domain.user.status.AuthErrorStatus;
import com.eatsfine.domain.user.status.UserSuccessStatus;
import com.eatsfine.global.apipayload.ApiResponse;
import com.eatsfine.global.auth.AuthCookieProvider;
